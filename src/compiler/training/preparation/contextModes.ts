 ...
 * `spawnfile.training-container.v3` stages no Grok binary — judges use the native
 * parent's pinned `/usr/local/bin/grok` — and adds the root broker entrypoint.
 */
const EXACT_MODES: Readonly<Record<string, number>> = { train: 0o555, "train-broker": 0o555 };
