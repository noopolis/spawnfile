...
export const renderDaimonBrokerProvisioning = (plans: RuntimeTargetPlan[]): string[] => {
  ...
  const program = [
    ...
    `fs.mkdirSync('${DAIMON_GROK_TURN_USAGE_LEDGER.directoryPath}', { recursive: true, mode: 0o750 }); fs.chownSync('${DAIMON_GROK_TURN_USAGE_LEDGER.directoryPath}', 0, 0); fs.chmodSync('${DAIMON_GROK_TURN_USAGE_LEDGER.directoryPath}', 0o750); fs.chownSync('${DAIMON_GROK_TURN_USAGE_LEDGER.directoryPath}', 2100, 2100);`,
