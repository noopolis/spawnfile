...
- `server.store.persistence.name` MAY name the runtime volume for durable stores. It is used verbatim as the host volume name, unchanged by run or deployment identity.
